function dlInterRbTime1(name)
% analyze dl rb inter usage time
    name_postfix = name;

    if exist(fullfile(cd, ['dlInterRb' name_postfix '.mat']), 'file')
        load(['dlInterRb' name_postfix '.mat']);
    else
        dataDir = ['zip' name_postfix 'matdata'];
        files = dir2(['./' dataDir]);
        ...
        save(['dlInterRb' name_postfix '.mat'], '-v7.3');
    end
    ...
    print(fig,['dl2h50rbinterval' name_postfix],'-dpdf');
    savefig(['dl2h50rbinterval' name_postfix]);
    ...
    fig.PaperSize = [fig_pos(3) fig_pos(4)];
    set(findall(gcf,'-property','FontSize'),'FontSize',14);
    print(fig,['dl2h50rbdr' name_postfix],'-dpdf');
    savefig(['dl2h50rbdr' name_postfix]);
    ...
    fig.PaperSize = [fig_pos(3) fig_pos(4)];
    set(findall(gcf,'-property','FontSize'),'FontSize',14);
    print(fig,['dl24h5rbinterval' name_postfix],'-dpdf');
    savefig(['dl24h5rbinterval' name_postfix]);
    ...
    fig.PaperSize = [fig_pos(3) fig_pos(4)];
    set(findall(gcf,'-property','FontSize'),'FontSize',14);
    print(fig,['dl24h5rbontime' name_postfix],'-dpdf');
    savefig(['dl24h5rbontime' name_postfix]);
    ...
    fig.PaperSize = [fig_pos(3) fig_pos(4)];
    set(findall(gcf,'-property','FontSize'),'FontSize',14);
    print(fig,['dl24h5rbofftime' name_postfix],'-dpdf');
    savefig(['dl24h5rbofftime' name_postfix]);
    ...
    fig.PaperSize = [fig_pos(3) fig_pos(4)];
    set(findall(gcf,'-property','FontSize'),'FontSize',14);
    print(fig,['dl24h5rbdr' name_postfix],'-dpdf');
    savefig(['dl24h5rbdr' name_postfix]);
end