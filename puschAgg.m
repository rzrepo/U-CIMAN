...
for i = 1:nof_files
    ...
    hour_rb_pos_count(dhour, :) = hour_rb_pos_count(dhour, :) + sum(ulrb>0);
 
    dlrb_size = numel(ulrb);
    nTTI = dlrb_size/nrb;
    ulrb = ulrb';
    local_per_tti_nrb = sum(ulrb>0);
