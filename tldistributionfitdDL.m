...
hold on; grid on;
bar(totalFit(1:4:21,:), 'EdgeColor',[1 1 1], 'LineWidth', 0.2);
...
print(fig,'sizevsfitrateDl','-dpdf');
savefig('sizevsfitrateDl');
...
save('dldistD', 'cmpFitDistOff', 'cmpFitDistOn', 'cmpFitDistInt', '-append');
...
set(0,'defaultAxesFontName', 'Arial');
hold on; grid on;
bar(cmpFitDistOff(1:4:21,:), 'EdgeColor',[1 1 1], 'LineWidth', 0.2);
...
set(findall(gcf,'-property','FontSize'),'FontSize', 28);
print(fig,'off1005discmpDl','-dpdf');
savefig('off1005discmpDl');
...
set(0,'defaultAxesFontName', 'Arial');
hold on; grid on;
bar(cmpFitDistOn(1:4:21,:), 'EdgeColor',[1 1 1], 'LineWidth', 0.2);
...
legend('Exp','Wei','Lgn','GeP','Gam', 'Location', 'Best');
set(findall(gcf,'-property','FontSize'),'FontSize',28);
print(fig,'on1005discmpDl','-dpdf');
savefig('on1005discmpDl');
...
set(0,'defaultAxesFontName', 'Arial');
hold on; grid on;
bar(cmpFitDistInt(1:4:21,:), 'EdgeColor',[1 1 1], 'LineWidth', 0.2);
...
legend('Exp','Wei','Lgn','GeP','Gam', 'Location', 'Best');
set(findall(gcf,'-property','FontSize'),'FontSize', 28);
print(fig,'int1005discmpDl','-dpdf');
savefig('int1005discmpDl');
...
save('dldistD', 'distributions', 'dlOff', 'dlInter', 'dlOn', '-append');